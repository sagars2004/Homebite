...
const lines = [
  "Checking what actually goes together...",
  "Not going to give you five options...",
  "Finding something good for tonight...",
  "Almost there...",
];
  ...
  return (
    <AppShell compact>
      <section className="relative z-10 flex min-h-[42vh] flex-col items-center justify-center pt-6 text-center">
        ...
        <p className="mt-3 min-h-7 text-muted-foreground" aria-live="polite">
          {lines[line]}
        </p>
        {error ? (
