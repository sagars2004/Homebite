...
import { HomebiteChat } from "../components/homebite/homebite-chat";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Tell Homebite what you have and get one confident dinner plan.",
      },
...
function RootComponent() {
  ...
  useEffect(() => {
    // Boot the Pendo (Novus) SDK once on the client. An empty visitor id lets
    // Pendo reuse a returning visitor from storage, else a new anonymous one.
